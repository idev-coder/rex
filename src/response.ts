...
response.status = function status(code: number): http.ServerResponse {
...
response.links = function (links: any): any {
...
response.send = function (body: any, ...args: any[]): any {
    var chunk = body;
    var encoding;
    var req = this.req;
    var type;
...
response.json = function (obj: any, ...args: any[]): any {
    var val = obj;
...
response.jsonp = function (obj: any, ...args: any[]): any {
    var val = obj;
...
response.sendStatus = function (statusCode: number): any {
...
response.sendFile = function (path: any, options: any, callback: any): void {
    var done = callback;
    var req = this.req;
    var res = this;
    var next = req.next;
...
response.download = function (path: any, filename: any, options: any, callback: any): any {
    var done = callback;
    var name = filename;
...
response.contentType = response.type = function (type: string): http.ServerResponse {
...
response.format = function (obj: any): http.ServerResponse {
    var req = this.req;
    var next = req.next;
...
response.attachment = function (filename: string): http.ServerResponse {
    if (filename) {
...
response.append = function (field: string, val: string | any[]): http.ServerResponse {
...
response.get = function (field: string): string {
    return this.getHeader(field);
};

response.clearCookie = function (name: string, options?: any): http.ServerResponse {
    if (options) {
        if (options.maxAge) {
...
response.location = function (url: string): http.ServerResponse {
    var loc;
...
response.render = function (view: any, options: any, callback: any): void {
