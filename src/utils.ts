...
export const normalizeTypes = function (types: any[]): any[] {
    var ret = [];
...
export const compileETag = function (val: any): Function {
    var fn;
...
export const compileQueryParser = function (val: any): Function {
    var fn;
...
export const compileTrust = function (val: any): Function {
...
export const setCharset = function (type: string, charset: string): string {
    if (!type || !charset) {
        return type;
    }
...
function acceptParams(str: string): any {
    var parts = str.split(/ *; */);
...
function newObject(): any {
    return {};
}

function parseExtendedQueryString(str: string): any {
    return qs.parse(str, {
