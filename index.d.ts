...
/**
 * Creates an Rex application. The rex() function is a top-level function exported by the rex module.
 */
declare function rex(): Rex;

declare namespace rex {
    /**
     * This is a built-in middleware function in Rex. It parses incoming requests with JSON payloads and is based on body-parser.
     * @since 4.16.0
     */
    var json: typeof bodyParser.json;

    /**
     * This is a built-in middleware function in Rex. It parses incoming requests with Buffer payloads and is based on body-parser.
     * @since 4.17.0
     */
    var raw: typeof bodyParser.raw;

    /**
     * This is a built-in middleware function in Rex. It parses incoming requests with text payloads and is based on body-parser.
     * @since 4.17.0
     */
    ...
    /**
     * This is a built-in middleware function in Rex. It serves static files and is based on serve-static.
     */
    var static: serveStatic.RequestHandlerConstructor<Response>;

    /**
     * This is a built-in middleware function in Rex. It parses incoming requests with urlencoded payloads and is based on body-parser.
     * @since 4.16.0
     */
    var urlencoded: typeof bodyParser.urlencoded;

    /**
     * This is a built-in middleware function in Rex. It parses incoming request query parameters.
     */
    ...
    interface CookieOptions extends CookieOptions { }
    interface Errback extends Errback { }
    ...
    interface Rex extends Rex { }
    interface Handler extends Handler { }
    interface IRoute extends IRoute { }
    interface IRouter extends IRouter { }
    interface IRouterHandler<T> extends IRouterHandler<T> { }
    interface IRouterMatcher<T> extends IRouterMatcher<T> { }
    interface MediaType extends MediaType { }
    ...
    interface RequestParamHandler extends RequestParamHandler { }
    interface Response<
        ResBody = any,
        Locals extends Record<string, any> = Record<string, any>,
    > extends Response<ResBody, Locals> { }
    interface Router extends Router { }
    interface Send extends Send { }
}
 ...
 * @link https://rexjs.com/en/api.html#res.cookie
 */
 ...
 *
 * @see https://rexjs.com/en/api.html#req.params
 *
 * @example
...
export interface Request<
    ...
    ReqQuery = ParsedQs,
    LocalsObj extends Record<string, any> = Record<string, any>,
> extends http.IncomingMessage, Rex.Request {
    /**
     ...
     * See: rex/lib/middleware/init.js
     */
...
> extends http.ServerResponse, Rex.Response {
    /**
     * Set status `code`.
     */
     ...
     * @link http://rexjs.com/4x/api.html#res.sendStatus
     *
     * Examples:
     *
     ...
     *    });
     *
     * By default Rex passes an `Error`
     ...
     * example by default rex supports "back" which redirects
...
export interface Application<
    LocalsObj extends Record<string, any> = Record<string, any>,
> extends EventEmitter, IRouter, Rex.Application {
    /**
     * Rex instance itself is a request handler, which could be invoked without
     * third argument.
     */
     ...
     * a "foo.jade" file Rex will invoke the following internally:
     *
     *     app.engine('jade', require('jade').__rex);
     *
     * For engines that do not provide `.__rex` out of the box,
     ...
     * the same signature that Rex expects: `(path, options, callback)`,
     * though note that it aliases this method as `ejs.__rex` internally
     ...
     * capabilities, for example Rex uses this internally not only for
    ...
    /**
     * Used to get all registered routes in Rex Application
     */
    _router: any;
